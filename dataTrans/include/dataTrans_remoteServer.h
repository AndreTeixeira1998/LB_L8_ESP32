...
#define DATATRAN_MQTT_ROOTOP_RESPCODE_AUTOMATION_SET_RES 	0x0E
...
void mqtt_rootDevEnvironmentParamRequestExcutionTrig(void);
...
void mqtt_rootDevEnvironmentParamRequestExcutionTrigByEvent(void);
