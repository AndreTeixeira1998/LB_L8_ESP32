...
void devForceAsMeshChild_opreatConfirm(void){
	...
	mboxDevForceAsChild_comfirm = lv_mbox_create(lv_scr_act(), NULL);
	lv_obj_set_protect(mboxDevForceAsChild_comfirm, LV_PROTECT_POS);
	lv_obj_align(mboxDevForceAsChild_comfirm, NULL, LV_ALIGN_CENTER, -35, -55);
	lv_obj_set_width(mboxDevForceAsChild_comfirm, 230);
	sprintf(wordsStr, "%s", dialogWordsStrGet_bySysLanguage(dialogTips_restart2Effect));
...
static void lvGui_pageSysLanguageSeclect_creat(void){
	...
	(devStatusDispMethod_landscapeIf_get())?
		(lv_obj_set_size(pageSettingA_sysLanguageSelect, 280, 190)):
		(lv_obj_set_size(pageSettingA_sysLanguageSelect, 200, 260));
	(devStatusDispMethod_landscapeIf_get())?
		(lv_obj_set_pos(pageSettingA_sysLanguageSelect, 20, 25)):
...
//			lv_cb_set_text(objpageDevALCSetCb_breathIf, "Breathing effect");
		...
		switch(devLanguageCountry_identifyGet()){
			...
			case languageCyId_Portuguese:
				...
				break;
			default:
				lv_obj_align(objpageDevALCSetCb_setAllSwitch, objpageDevALCSetCb_breathIf, LV_ALIGN_OUT_BOTTOM_MID, -3, -10);
				break;}
...
//	lv_label_set_text(textSettingA_tempCalibration, "Temperature calibration:");
	...
	switch(devLanguageCountry_identifyGet()){
		case languageCyId_Arabic:lv_obj_align(textSettingA_tempCalibration, textSettingA_screenBrightness, LV_ALIGN_OUT_BOTTOM_RIGHT, 0, 60);break;
		default:lv_obj_align(textSettingA_tempCalibration, textSettingA_screenBrightness, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 60);break;}
...
//	lv_label_set_text(textSettingA_screenLightTime, "Screen light time:");
	...
	switch(devLanguageCountry_identifyGet()){
		case languageCyId_Arabic:lv_obj_align(textSettingA_screenLightTime, textSettingA_tempCalibration, LV_ALIGN_OUT_BOTTOM_RIGHT, 0, 60);break;
		default:lv_obj_align(textSettingA_screenLightTime, textSettingA_tempCalibration, LV_ALIGN_OUT_BOTTOM_LEFT, 0, 60);break;}
