...
typedef enum{
	...
	msgType_devCurtainDriver_orbitalCalibraStart,
	msgType_devCurtainDriver_orbitalCalibraProcess_a,
	msgType_devCurtainDriver_orbitalCalibraProcess_b,
	msgType_devCurtainDriver_orbitalCalibraComplete,

	msgType_devCurtainDriver_orbitalCalibraCustom_a,
	msgType_devCurtainDriver_orbitalCalibraCustom_b,
...
typedef struct{
	...
	union unn_msgDats_devCurtain{
		...
		struct stt_data_orbitalCalibraProcess{
			uint8_t orbitalTimeDetectSeconds;
		}data_orbitalCalibraProcess;
...
extern xQueueHandle msgQh_devCurtainCalibration;
