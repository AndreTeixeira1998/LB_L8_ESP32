...
static uint32_t devParam_ElecPowerMw = 0;
...
//	printf("pcntCount:%d.\n", freq_elecMeansure);
	...
	devParam_ElecPowerMw = (uint32_t)(devParam_ElecDetect.eleParam_power * 1000.0F);
...
uint32_t devDriverBussiness_elecMeasure_valElecPowerMwGet(void){

	return devParam_ElecPowerMw;
}
