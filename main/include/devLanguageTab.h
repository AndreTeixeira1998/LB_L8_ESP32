 ...
 *      DEFINES 
 **********************/	
#define DEV_LANGUAGE_COUNTRY_NUM_MAX		4
...
typedef enum{
	...
	tls_mSetting_tempParamDisp,
	tls_mSetting_tempDispCels,
	tls_mSetting_tempDispFahr,
	...
	tls_mSysInfo_parentSSID,
	tls_mSysInfo_routerName,
