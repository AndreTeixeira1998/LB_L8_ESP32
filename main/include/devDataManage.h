...
#define L8_DEVICE_VERSION_REF_DISCRIPTION		"L8-v1.1.2[202012270800]" //固件说明描述版本号
...
#define DEVICE_DRIVER_DEFINITION				DEVICE_DRIVER_METHOD_BY_SELF_HARDWARE
 ...
 #define DEV_TYPES_PANEL_DEF_INDEP_HEATER		(0x04 + DEVICE_FLASH_PARTITIONS_OFFSET) //(20H[32] + 04 = 35)面板类型定义：仅热水器
...
#define STR_VERSION_REALES_REFERENCE_DFT		" 1.The screen display confusion problem is\n"\
												"   completely solved.\n\n"\
												" 2.Support automation function with App.\n\n"\
	...
	#define STR_VERSION_REALES_REFERENCE_T		" 1.Minimize the problem of freezing.\n\n"\
												" 2.The Bezel light can be set, in the\n"\
												"   option 'Decorative lamp set' of \n"\
												"   the setting page.\n\n"\
												" 3.Add a new system languages,\n"\ 
												"   Portuguese\n\n"\
												" 4.When the voltage is too low, \n"\
												"   the automatic turn-off time \n"\
												"   is precisely optimized. \n\n"\
												" 5.The voltage precision is\n"\
												"   synchronized to the mobile\n"\
												"   phone display. \n\n"

	#define STR_VERSION_REALES_REFERENCE		" 1.Turn off voltage is divided into\n"\
												"   three stages.\n\n"\
